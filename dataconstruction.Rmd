...
Within the folcnet function I specify it should include all researchers from sociology and political science departments in Dutch Universities. I also specify my waves as 2015-2018 (wave 1) and 2019-2023 (wave 2). Lastly, I want a directed network in which the last named author on a paper is the one who sent the ties, and I therefore choose type "last". 
...
Now I apply the genderizer function to the data I just created.
```{r, eval= F}
...
## Attach
And then I attach the demographics data which includes gender to the collaboration network again. 
```{r, eval= F}
...
As a result I now have a demographics list within my data including the gender of people. As you will read in the descriptive analyses, the gender of only 22 people was missing (3.26)
