...
Social Identity Theory (SIT) posits that group membership forms a central part of an individual’s self-concept and can produce ingroup favoritism and outgroup bias [@Tajfel_Turner]. Because gender is a salient social identity, individuals often automatically categorize others as male or female during professional interactions [@Carter]. This categorization can shape collaboration decisions: when researchers A and B share the same gender, their common identity can foster trust and ingroup cohesion, making A more inclined to collaborate with someone like B and more hesitant to collaborate with C if C has a different gender.

Based on this reasoning, the opposite of Hypothesis 1 can be expected: A is more likely to avoid collaboration with C when C differs in gender from both A and B, perceiving C as an outgroup member. Formally, this leads to the following hypothesis:
