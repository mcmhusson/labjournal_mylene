...
This research examined gender homophily within triadic collaboration structures, focusing on whether, in triads where researcher A collaborates with researcher B and researcher B with researcher C, the gender of C affects A’s likelihood of collaborating them when A and B share the same gender. Using web-scraped data on all researchers within the sociology and political science departments at Dutch universities from 2015–2023, I conducted a social network analysis over two waves (2015–2018 and 2019–2023).

Studying this question is important because gender homophily at the dyadic level is well-documented in academia: researchers tend to collaborate with others of the same gender [@wang2023homophily]. Such micro-level preferences can aggregate into macro-level patterns of gender segregation, reinforcing structural inequalities by limiting access to influential networks, mentorship, and high-status collaborations [@powell2018gender]. This study extends the literature by examining whether these patterns persist in triadic structures or whether triads might provide opportunities for cross-gender collaboration.
